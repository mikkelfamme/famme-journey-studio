...
export class AppErrorBoundary extends Component<{ children: ReactNode }, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) { console.error('Journey Studio by Famme render error', error, info); }
  async restore() {
