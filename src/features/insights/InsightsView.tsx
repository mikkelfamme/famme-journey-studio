...
export function InsightsView() {
  ...
  return <section className="content-section insights-page">
    ...
    {tab === 'overview' && <>
      ...
      {!active ? <div className="empty-state"><Database size={30}/><h3>No performance snapshot yet</h3><p>Import a Journey Studio by Famme performance snapshot from Settings. Your journey architecture remains usable without data.</p></div> : <>
